...
class VoteOtpVerificationScreen extends StatefulWidget {
  final String phoneNumber;
  final Map<String, dynamic> candidateData;

  const VoteOtpVerificationScreen({
    Key? key,
  ...
  @override
  State<VoteOtpVerificationScreen> createState() => _VoteOtpVerificationScreenState();
}

class _VoteOtpVerificationScreenState extends State<VoteOtpVerificationScreen> {
  ...
  Future<void> _verifyOTP() async {
    ...
    if (_enteredOtp == _dummyOtp) {
      if (mounted) {
        // Navigate to vote confirmation on success
